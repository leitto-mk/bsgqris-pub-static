...
<template>
    <Fluid class="layout-menu bg-white dark:bg-zinc-900 h-svh">
        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div class="flex flex-row justify-center mx-8 lg:mx-20 gap-3 lg:gap-14 mt-5 lg:mt-10 hidden">
                <Button
                    label="User"
                    icon="pi pi-desktop"
            ...
            <div v-if="terminal_state" class="flex flex-row justify-center mx-8 lg:mx-20 gap-3 lg:gap-14 mt-10 mb-10 hidden">
            ...
            <div v-if="terminal_state" class="flex flex-col lg:flex-row lg:row-span-3 justify-center gap-1 lg:gap-16 max-md:mx-12 mt-5 hidden">
            ...
            <div v-if="transactions_state" class="flex flex-row justify-center mx-5 lg:mx-1 mt-10 mb-10 hidden">
            ...
            <div v-if="transactions_state && transaction_date" class="flex flex-col justify-center mx-12 lg:mx-80 mt-10 lg:mt-20 lg:mb-28 hidden">
                <div
